        ...
        return value
          ? value == 'true' ||
            (value == 'false'
              ...
              : value == 'null'
                ? null
                : +value + '' == value ? +value : /^[\[\{]/.test(value) ? $.parseJSON(value) : value)
          : value;
      } catch (e) {
        return value;
      }
      ...
      $.fn[operator] = function() {
        ...
        return this.each(function(_, target) {
          ...
          target =
            operatorIndex == 0
              ? target.nextSibling
              : operatorIndex == 1 ? target.firstChild : operatorIndex == 2 ? target : null;
    ...
    function mimeToDataType(mime) {
      ...
      return (
        (mime &&
          (mime == htmlType
            ? 'html'
            : mime == jsonType ? 'json' : scriptTypeRE.test(mime) ? 'script' : xmlTypeRE.test(mime) && 'xml')) ||
        'text'
      );
    }
